...
namespace CommandIDs {
  export const displayNumbering = 'user:display-numbering';

  export const displayH1Numbering = 'user:display-h1-numbering';

  export const displayOutputNumbering = 'user:display-outputs-numbering';

  export const showPanel = 'user:show-panel';

  export const toggleCollapse = 'user:toggle-collapse';
}
...
async function activateTOC(
  ...
  toc.title.caption = trans.__('Table of Contents 22223333');
  ...
  if (restorer) {
    ...
    restorer.add(toc, '@jupyterlab/user:plugin');
  }
  ...
  app.shell.add(toc, 'left', { rank: 20, type: 'Table of Contents 2333' });
...
const registry: JupyterFrontEndPlugin<ITableOfContentsRegistry> = {
  id: '@jupyterlab/user-extension:registry',
...
const tracker: JupyterFrontEndPlugin<ITableOfContentsTracker> = {
  id: '@jupyterlab/user-extension:tracker',
